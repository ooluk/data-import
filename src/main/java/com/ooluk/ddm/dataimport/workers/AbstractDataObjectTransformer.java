...
/**
 * An abstract implementation of DataObjectTransformer to provide common functionality. 
 * 
 * @author Siddhesh Prabhu
 * @since 1.0
 *
 */
public abstract class AbstractDataObjectTransformer implements DataObjectTransformer {
